...
apache_mirror_json=$(curl https://www.apache.org/dyn/closer.cgi\?as_json\=1 || echo '{"preferred":"https://downloads.apache.org/"}')
...
(curl ${apache_mirror}${maven_dist_path} || curl ${apache_backup_mirror}${maven_dist_path}) | tar xz --strip=1 -C maven
